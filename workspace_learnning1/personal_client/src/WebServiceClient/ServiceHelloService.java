 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://WebService/", wsdlLocation = "http://localhost:9001/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://WebService/", "ServiceHelloService");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://WebService/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService/", "ServiceHelloPort"), ServiceHello.class, features);
    }
