package A_javabase._basic10IO.image;
...
public class ImageScale {
	...
	public void picscale(String source, String target, int w, int h) {
		...
		try {
			BufferedImage bi = ImageIO.read(f);
			int[] arr = getImageWidthAndHeight(bi.getWidth(), bi.getHeight(), w, h);
			width = arr[0];
			height = arr[1];
			BufferedImage out = null;
			ImageScale scal = new ImageScale();
	...
	public static void main(String[] args) {
		...
		long start = System.currentTimeMillis();
		is.scale("C://Users//jiawen//Pictures//wKgC7l8_gMKAE-5xAEEcRYC6TXY51.jpeg"
				, "C://Users//jiawen//Pictures//testpic1.jpg", 200, 100);
		long end = System.currentTimeMillis();
