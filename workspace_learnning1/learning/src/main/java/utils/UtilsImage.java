...
public class UtilsImage {
	...
	public static void main(String[] args) {
		...
		/*
		 * new UtilsImage().pressText("我是测试水印文字",
		 * "/home/zcbase/nfs/2017/12/13/16pic_1647532_b_1513214676015.jpg",
		 * "/home/zcbase/nfs/2017/12/13/new.jpg", "default", Font.BOLD, 38,
		 * Color.WHITE, 0, 0, 0.4f);
		 */
		...
		// /farms2/src/main/webapp/home/zcbase/nfs/xzyzgl/yingmowhite.jpg
				, "/home/zcbase/nfs/2017/12/13/yingmowhite.jpg", "/home/zcbase/nfs/2017/12/13/new电饭锅2.jpg", "jpg", 0.5,
				0.5, 0.9f);

	}

	public void pressText(String pressText, String srcImageFile, String destImageFile, String suffix, String fontName,
	 ...
	 *            颜色
	 * @param d
	 *            偏移量 百分比的实际值，，例：100%:1,50%:0.5
	 * @param f
	 *            意义同x， x/y 方向同数学上的x/y轴
	 * @param alpha
	 *            透明度
	 */
	public void pressImage(String srcImageFile, String opImageFile, String destImageFile, String suffix, double d,
			double f, float alpha) {
	...
	public void pressImage(File imgsrc, String opImageFile, File destImageFile, String suffix, double d, double f,
			float alpha) {
	...
	public void pressText(String pressText, File imgsrc, String subffix, File destImageFile, String fontName,
			int fontStyle, int fontsize, Color color, int x, int y, float alpha) {
