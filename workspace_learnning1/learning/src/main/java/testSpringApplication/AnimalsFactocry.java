...
public class AnimalsFactocry {
	...
	public Object  getAnimals(String animalname) throws InstantiationException, IllegalAccessException, ClassNotFoundException{
	...
	public BeanAnimals  getAnimals2(Class<? extends BeanAnimals> cls) throws InstantiationException, IllegalAccessException{
		BeanAnimals bean1 = cls.newInstance();
		return bean1;
	}
	public BeanAnimals  getAnimals2(String animalname) throws InstantiationException, IllegalAccessException, ClassNotFoundException{
