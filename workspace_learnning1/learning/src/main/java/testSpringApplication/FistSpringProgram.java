...
public class FistSpringProgram {
	...
	public void test() {
		 ...
		 * FileSystemXmlApplicationContext("C:"+File.separator+"Users"+File.
		 * separator+"Administrator"+File.separator+"workspace"+File.separator+
		 * "JAVABasic"+File.separator+"src"+File.separator+"main"+File.separator
		 * +"resources"+File.separator+"springbasic"+File.separator+
		 * "SpringMVC.xml"); String id = applicationContext.getId();
