...
public class gameContent {
	/**
	 * 斗地主个人版 1牌桌初始化 （指定玩家位置，顺时针） * 3扑克牌初始化 （扑克存储器） 2等待玩家就位，准备
	 * （标记玩家顺序,全员准备完毕才能开始3）
	 * 
	 * 4洗牌，自动发牌，随机指定首家叫牌 （扑克按顺序发） 5顺时针判定地主与农民，若是一圈未能定出地主，则重复步骤4-5
	 * （标记轮次2），若第二轮依然未决出，则自动判定首家地主 6地主优先出牌，顺时针判定玩家是否可以接牌
	 * (比较牌组大小）,判定玩家剩余卡牌是否=0，=0时获胜。 =0时本轮牌局结束,打印结果,给出是否继续按钮
	 */
